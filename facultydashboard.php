  ...
  <body class="app sidebar-mini" >
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item " href="facultylogout.php"><i class="app-menu__icon fa fa-eye"></i><span class="app-menu__label">Logout</span></a></li>
      </ul>
    </aside>
...
<img src="assets/img/faculty.jpeg" width="800" height="600"></img>
</form>
