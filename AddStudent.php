        ...
        <div class="col-md-6">
           ...
           <div class="form-group row">
                   ...
                   <div class="form-group row">
                     ...
                     <div class="col-md-8">
                       <input class="form-control col-md-8" type="text"  name="p4"  placeholder="Enter Username" required>
                     </div>
                   </div>
                   <div class="form-group row">
                     <label class="control-label col-md-3">PASSWORD</label>
                     <div class="col-md-8">
                       <input class="form-control col-md-8" type="text"  name="p10"  placeholder="Enter password" required>
                     </div>
                   </div>
                   <div class="form-group row">
